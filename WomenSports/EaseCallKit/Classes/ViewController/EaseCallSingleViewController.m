...
- (void)viewDidLoad {
    ...
    [self.remoteHeadView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.contentView.mas_top).mas_offset(121*CK_HEIGHT_Sales);
    }];
    [self.remoteHeadView.layer setCornerRadius:51];
    [self.remoteHeadView.layer setBorderWidth:3];
    [self.remoteHeadView.layer setBorderColor:[UIColor colorWithRed:17/255.0f green:215/255.0f blue:225/255.0f alpha:1].CGColor];
    [self.remoteHeadView setClipsToBounds:YES];
    ...
    [self.remoteNameLable mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.remoteHeadView.mas_bottom).offset(6);
        make.centerX.equalTo(self.contentView);
    }];
    ...
    [self.statusLable mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.remoteNameLable.mas_bottom).with.offset(202*CK_HEIGHT_Sales);
        make.centerX.equalTo(self.contentView);
    }];
