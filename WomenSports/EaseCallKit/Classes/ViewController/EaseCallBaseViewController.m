...
//         }
    ...
    [self.miniButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.contentView).mas_offset(KStatusHeight + 10);
    ...
    [self.hangupButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(self.contentView).offset(-164);
        make.left.equalTo(self.contentView.mas_left).mas_offset(57*CK_WIDTH_Sales);
    ...
    [self.answerButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(self.contentView.mas_right).offset(-57*CK_WIDTH_Sales);
