...
@interface WSNavigationController ()<UIGestureRecognizerDelegate,UINavigationControllerDelegate>
...
- (void)viewDidLoad {
    ...
    if (@available(iOS 15.0, *)) {
        ...
        barApp.backgroundColor = K_WhiteColor;
        ...
        [navigationBarAppearance setBackgroundImage:[UIImage k_imageWithColor:K_WhiteColor] forBarMetrics:UIBarMetricsDefault];
        [navigationBarAppearance setShadowImage:[UIImage k_imageWithColor:K_WhiteColor]];
...
//        self.tabBarController.tabBar.hidden = YES;
        ...
        [button setImage:[UIImage imageNamed:@"navigation_back_main"] forState:UIControlStateNormal];
        [button setImage:[UIImage imageNamed:@"navigation_back_main"] forState:UIControlStateHighlighted];
