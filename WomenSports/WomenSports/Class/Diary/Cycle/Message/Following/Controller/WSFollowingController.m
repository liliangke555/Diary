...
@interface WSFollowingController ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
...
@implementation WSFollowingController
...
- (void)reloadList {
    WSFollowingListRequest *request = [WSFollowingListRequest.alloc init];
...
- (void)cancelFollowWithModel:(WSFollowDetailModel *)model {
    WSCancelFollowRequest *requet = [WSCancelFollowRequest.alloc init];
    requet.userId = model.id;
    CKWeakify(self);
