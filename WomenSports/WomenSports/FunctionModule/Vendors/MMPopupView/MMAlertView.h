...
typedef void(^MMPopupSetImageViewHandler)(UIImageView *imageView);
...
@property (strong, nonatomic) UIColor *fristItemBackgroundColor;  //第一个按钮 背景色

@property (strong, nonatomic) UIColor *fristItemNormalColor;
