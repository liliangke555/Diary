...
//        self.layer.borderColor = config.splitColor.CGColor;
        ...
        if (imageHandler) {
            ...
            [imageView mas_makeConstraints:^(MASConstraintMaker *make) {
                make.top.equalTo(lastAttribute).offset(38);
...
//                make.height.mas_equalTo(168);
        ...
        if ( title.length > 0 )
        {
            ...
            self.titleLabel.font = KSFProRoundedMediumFont(config.titleFontSize);
        ...
        if ( detail.length > 0 )
        {
            ...
            self.detailLabel.font = KSFProRoundedMediumFont(config.detailFontSize);
...
//            self.inputView.placeholder = inputPlaceholder;
            ...
            NSString *string = @"Please enter your weight";
            NSMutableAttributedString *attString = [NSMutableAttributedString.alloc initWithString:string];
            [attString addAttribute:NSForegroundColorAttributeName value:[UIColor mm_colorWithHex:0xAFAABBFF] range:NSMakeRange(0, string.length)];
            [self.inputView setAttributedPlaceholder:attString];
...
//        lastAttribute = line.mas_bottom;
        ...
        [self.buttonView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(lastAttribute).mas_offset(25);
            make.left.right.equalTo(self);
        }];
        [self.buttonView setBackgroundColor:MMHexColor(0xF6F7F9FF)];
        ...
        for ( NSInteger i = 0 ; i < items.count; ++i )
        {
            ...
            [btn mas_makeConstraints:^(MASConstraintMaker *make) {
                ...
                if ( items.count <= 2 && !titleTooLong)
                {
                    ...
                    {
                        make.left.equalTo(lastButton.mas_right).mas_offset(0.5);
...
//            [btn.layer setBorderColor:K_MainColor.CGColor];
//            [btn.layer setBorderWidth:1];
            ...
            btn.titleLabel.font = item.highlight?KBoldFont(18):KMediumFont(18);
        }
