...
@property (nonatomic, strong) UIButton *videoButton;//视频通话
...
//    }];
    ...
    [_videoButton setBackgroundImage:[UIImage easeUIImageNamed:@"video_icon"] forState:UIControlStateNormal];
    [_videoButton setBackgroundImage:[UIImage easeUIImageNamed:@"video_icon "] forState:UIControlStateSelected];
    [_videoButton addTarget:self action:@selector(videoButtonAction:) forControlEvents:UIControlEventTouchUpInside];
    [self addSubview:self.videoButton];
    [_videoButton Ease_makeConstraints:^(EaseConstraintMaker *make) {
        make.top.equalTo(self).offset(10);
        make.left.equalTo(self).offset(16);
        make.width.Ease_equalTo(@30);
...
//    [_sendButton setBackgroundImage:[UIImage easeUIImageNamed:@"more-unselected"] forState:UIControlStateNormal];
//    [_sendButton setBackgroundImage:[UIImage easeUIImageNamed:@"more-selected"] forState:UIControlStateSelected];
    [_sendButton setTitle:@"Send" forState:UIControlStateNormal];
    [_sendButton setTitleColor:UIColor.whiteColor forState:UIControlStateNormal];
    [_sendButton setBackgroundColor:[UIColor colorWithHexString:@"#11D7E1"]];
    [_sendButton.titleLabel setFont:[UIFont fontWithName:@"PingFangSC-Medium" size:14]];
    [_sendButton addTarget:self action:@selector(sendButtonAction:) forControlEvents:UIControlEventTouchUpInside];
    [self addSubview:_sendButton];
    [_sendButton Ease_makeConstraints:^(EaseConstraintMaker *make) {
        make.top.equalTo(self).offset(10);
        make.right.equalTo(self).offset(-16);
        make.width.Ease_equalTo(54);
    ...
    [_emojiButton Ease_makeConstraints:^(EaseConstraintMaker *make) {
        make.top.equalTo(self).offset(10);
        make.right.equalTo(self.sendButton.ease_left).offset(-kModuleMargin);
        make.width.height.Ease_equalTo(kIconwidth);
    }];
    ...
    self.textView.font = [UIFont fontWithName:@"SFProRounded-Regular" size:14];
    ...
    self.textView.backgroundColor = [UIColor colorWithHexString:@"#F6F6F6"];
    self.textView.layer.cornerRadius = 16;
    self.textView.placeHolder = @"Let’s talk about it";
    self.textView.placeHolderColor = [UIColor colorWithHexString:@"#C2C2C2"];
    ...
    [self.textView Ease_makeConstraints:^(EaseConstraintMaker *make) {
        ...
        if (_viewModel.inputBarStyle == EaseInputBarStyleAll) {
            make.left.equalTo(self.videoButton.ease_right).offset(kModuleMargin);
    ...
    _bottomLine.backgroundColor = [UIColor colorWithHexString:@"#FFFFFF"];
...
- (void)videoButtonAction:(UIButton *)sender {
    if ([self.delegate respondsToSelector:@selector(chatBarDidVideoAction)]) {
        [self.delegate chatBarDidVideoAction];
    }
}
//语音
