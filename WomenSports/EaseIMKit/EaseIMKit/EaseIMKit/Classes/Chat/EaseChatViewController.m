                                          ...
                                          chatViewModel:(EaseChatViewModel *)viewModel
{
    ...
    if (self) {
        ...
        [[EaseIMKitManager shareInstance] setConversationId:_currentConversation.conversationId];
        if (!_viewModel) {
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    [[EaseIMKitManager shareInstance] markAllMessagesAsReadWithConversation:self.currentConversation];
}
...
- (void)dealloc
{
    [[EaseIMKitManager shareInstance] setConversationId:@""];
...
- (void)chatBarDidVideoAction {
    if ([self.delegate respondsToSelector:@selector(didClickVideoAction)]) {
        [self.delegate didClickVideoAction];
    }
}
